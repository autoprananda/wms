...
export default {
  ...
  methods: {
    onBindData() {
      ...
      this.Nationality.dropdown_details_desc = this.selected.nationality.dropdown_details_desc
      this.CountryOfNationality.country_name = this.selected.country.country_name
      this.IDType.dropdown_details_desc = this.selected.type_id.dropdown_details_desc
      ...
      this.Status.dropdown_details_desc = this.selected.status.dropdown_details_desc

      this.Salutation.dropdown_details_desc = this.selected.salutation.dropdown_details_desc
      this.FirstName = this.selected.first_name
      this.MiddleName = this.selected.middle_name
      this.LastName = this.selected.last_name
      this.Gender.dropdown_details_desc = this.selected.gender.dropdown_details_desc
      ...
      this.Religion.dropdown_details_desc = this.selected.religion.dropdown_details_desc
      this.MaritalStatus.dropdown_details_desc = this.selected.marital.dropdown_details_desc
      this.MotherMaidenName = this.selected.mother_maiden_name

      this.EducationalBackground.dropdown_details_desc = this.selected.educational.dropdown_details_desc
      this.InvestmentObjective.dropdown_details_desc = this.selected.investment_object.dropdown_details_desc 
      this.IncomeLevel.dropdown_details_desc = this.selected.income_level.dropdown_details_desc

      this.GlobalCifNumber = this.selected.gcif_number
      this.SalesName  = this.selected.sales_name
      this.BranchName.branch_name = this.selected.branch.branch_name
      this.RegistrationDate = this.selected.registration_date
      this.DateLastUpdate = this.selected.data_last_update
      this.LobCode.dropdown_details_desc = this.selected.lob.dropdown_details_desc
      this.CustomerGroup.dropdown_details_desc = this.selected.customer_group.dropdown_details_desc

      this.TaxIdNumber = this.selected.tin_number
      this.TinForeignTin = this.selected.tin_number
      this.IssuanceCountry.country_name = this.selected.issuance_country.country_name
