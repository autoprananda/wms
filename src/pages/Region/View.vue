                    ...
                    <q-card-section>
                      ...
                      <div class="row q-col-gutter-md">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                          <q-field Standard label="Country" stack-label>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6" />
                        <div class="col-xs-12 col-sm-6 col-md-6">
                          <q-field Standard label="Region Code" stack-label>
                            <template v-slot:control>
                              <div
                                class="self-center full-width no-outline"
                                tabindex="0"
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6" />
                        <div class="col-xs-12 col-sm-6 col-md-6">
                          <q-field Standard label="Region Name" stack-label>
                            <template v-slot:control>
                              <div
                                class="self-center full-width no-outline"
                                tabindex="0"
...
export default {
  ...
  methods: {
    onBindData() {
      this.RegionCode = this.selected.region_code
      this.RegionName = this.selected.region_name
      this.Country = this.selected.country.country_name
    },
    onBack() {
