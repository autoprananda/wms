      ...
      <q-card bordered>
        <q-card-section>
          <q-breadcrumbs>
            ...
            <q-breadcrumbs-el label="Currencies" icon="fas fa-dollar-sign" />
          </q-breadcrumbs>
        </q-card-section>
        <q-separator inset />
                  ...
                  <template v-slot:body="props">
                    <q-tr :props="props">
                      ...
                      <q-td
                        ...
                        >{{ props.row.currencies_code }}</q-td
                      >
                      <q-td key="currencies_desc" :props="props">{{
                        props.row.currencies_desc
                      }}</q-td>
...
export default {
  ...
  methods: {
    ...
    onUpdate() {
      ...
      this.$router.push({ path: '/currencies/edit' })
    },
    onView() {
