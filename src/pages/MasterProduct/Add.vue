                          ...
                          <q-card-section>
                            ...
                            >
                              ...
                              <q-tab
                                ...
                                name="two"
                                @click="changeStatusTab(), clearValidate()"
                              >
                                <q-input
                                  class="form-input"
                                  type="text"
                                  v-model="ActiveTab"
                                  v-validate="'required'"
                                  data-vv-name="Settlement Info"
                                  :error="errors.has('Settlement Info')"
                                />
                              </q-tab>
                            </q-tabs>
                            ...
                            <q-separator />
                            <span
                              v-show="errors.has('Settlement Info')"
                              class="error"
                              >{{ errors.first('Settlement Info') }}</span
                            >
                                  ...
                                  <div class="row q-col-gutter-md">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                      <q-select
                                        ...
                                        :error="
                                          errors.has('Distribution Of Sales')
                                        "
                                      >
                                        <q-tooltip
                                          anchor="top middle"
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                      ...
                                      <span
                                        v-show="errors.has('Customer Segment')"
                                        class="error"
                                      >
                                ...
                                <div class="q-pl-xs q-pr-xs q-pt-sm q-pb-sm">
                                  <div class="row q-col-gutter-md">
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                      ...
                                      <span
                                        v-show="errors.has('Settlement Period')"
                                        class="error"
                                      >
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                      <q-select
                                        ...
                                        :error="
                                          errors.has('Devidend Reinvested')
                                        "
                                      >
                                        <q-tooltip
                                          anchor="top middle"
...
export default {
  ...
  methods: {
    ...
    onRefresh() {
      setTimeout(() => {
        this.$apollo.queries.ProductCodeMaster.refetch().then(response => {
          this.ProductCodeMaster = response.data.wms_products
          console.log(this.ProductCodeMaster, '====>>>')
          this.generateProductNumber()
        })
      }, 2000)
    },
    generateProductNumber() {
      this.ProductCodeMaster.forEach(dataAccount => {
        this.ProductCodeNext.push(dataAccount.product_code)
      })
      if (this.ProductCodeNext[0] !== undefined) {
        this.ProductCodeNext[0] = this.ProductCodeNext[0].split('-')
        console.log(this.ProductCodeNext[0], '>>>>>>>number')
        let x = +this.ProductCodeNext[0][1] + 1
        let y =
          x > 9
            ? x > 99
              ? x > 999
              ...
              : '00000' + x
            : '000000' + x
        this.ProductCode = 'PRD-' + y
        return this.ProductCode
      } else {
        this.ProductCode = 'PRD-' + '0000001'
        return this.ProductCode
      }
    },
    SubmitButton() {
      ...
      this.$apollo
        .mutate({
          mutation: ActionsInsMasterProdCode,
          variables: {
            objects: {
        ...
        .then(response => {
          ...
          this.$q.notify({
            ...
            message: 'Product ' + this.Description + ' ' + 'Has Been Submitted'
          })
