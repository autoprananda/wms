...
export default {
  ...
  methods: {
    onBindData() {
      ...
      this.FundManager = this.selected.fund_manager
      ...
      this.CustodyBank = this.selected.reference_cust_bank.dropdown_details_desc
      ...
      this.Classification = this.selected.classification.dropdown_details_desc
