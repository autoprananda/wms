      ...
      <q-card bordered>
        <q-card-section>
          <q-breadcrumbs>
            ...
            <q-breadcrumbs-el label="Product" icon="fab fa-dropbox" />
          </q-breadcrumbs>
        </q-card-section>
        <q-separator inset />
                ...
                >
                  ...
                  <template v-slot:body="props">
                    <q-tr :props="props">
                      ...
                      >
                      <q-td
                        key="classification.dropdown_details_desc"
                        :props="props"
                      >
                        {{ props.row.classification.dropdown_details_desc }}
                      </q-td>
                      <q-td
                        key="reference_cust_bank.dropdown_details_desc"
                        :props="props"
                      >
                        {{
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          name: 'classification.dropdown_details_desc',
          label: 'Classification',
          field: 'classification.dropdown_details_desc',
          align: 'Left',
          sortable: true
        },
        {
          name: 'reference_cust_bank.dropdown_details_desc',
          label: 'Bank Custodian',
          field: 'reference_cust_bank.dropdown_details_desc',
          align: 'Left',
          sortable: true
        },
        {
